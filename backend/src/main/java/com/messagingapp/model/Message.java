...
@Document("messages") public record Message(@Id String id, @Indexed String conversationId, String senderId, String content, Instant createdAt, Status status) { public enum Status { SENT } }
